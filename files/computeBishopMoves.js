function computeBishopMoves(board, position) {
    ...
    for (const { line, column } of dirs) {
        ...
        for (let i = 1; i < 8; i++) {
            ...
            // Se já tiver saído do tabuleiro, para de percorrer esta direção
            if (0 > l || l > 7 || 0 > c || c > 7) break;
            ...
            if (casa === "") {
                ...
                // Se estiver ocupada, independemente da peça, para de percorrer esta direção
                break;
            }
        }
    }
